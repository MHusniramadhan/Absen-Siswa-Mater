                    ...
                    <div class="container">
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    <h2 class="text-white pb-2 fw-bold">SDN Paku Jaya 02</h2>
                                    <!-- <h5 class="text-white op-7 mb-2">Absen Lebih mudah gunakan Aplikasi Absensi</h5> -->
                                </div>
                                <div class="ml-md-auto py-2 py-md-0">
                                    <a href="#" class="btn btn-white btn-border btn-round mr-2"> Jl.Patal 1 No. 15, RT.004/RW.3, Paku Jaya,<br>
                                     Kecamatan Serpong Utara, Tangerang Selatan, Banten (15220)</a>
